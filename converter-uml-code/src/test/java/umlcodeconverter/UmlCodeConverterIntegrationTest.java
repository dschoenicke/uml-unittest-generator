...
public class UmlCodeConverterIntegrationTest extends UmlCodeConverterTests {
	...
	public void verifyRepresentationStructure() {
		...
		assertEquals(umlModel.getName(), codeRepresentation.getPackages().get(0).getName());
		codeGenericClass = (CodeClass) codeRepresentation.getPackages().get(0).getPackages().get(0).getElements().get(2);
