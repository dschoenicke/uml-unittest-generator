 ...
 * Furthermore, this class holds a map of {@link uml.UmlPackage} and {@link code.CodePackage}s to be used by the {@link umlcode.converter.element.ElementConverter}, 
 * as well as a map of{@link uml.UmlElement}s and {@link code.CodeElement}s to be used by the {@link umlcode.converter.relationship.RelationshipConverter}
 * 
 * @author dschoenicke
 *
 */
