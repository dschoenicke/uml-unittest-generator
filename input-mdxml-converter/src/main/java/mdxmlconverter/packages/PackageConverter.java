...
public class PackageConverter {
	...
	/** 
	 * Static method converting a given {@link mdxml.PackagedElement} with type 'uml:Package' to an {@link uml.UmlPackage} and adds it to the {@link mdxmlconverter.temporary.TemporaryModel}
	 * 
	 * @param packagedElement the {@link mdxml.PackagedElement} to convert
	 * @param tmpModel the {@link mdxmlconverter.temporary.TemporaryModel} to add the converted package to
	 ...
	 * @param tmpModel the {@link mdxmlconverter.temporary.TemporaryModel} to which the {@link uml.UmlPackage}s are added
	 */
	 ...
	 * The id of the {@link mdxml.PackagedElement} is added to a map of the {@link mdxmlconverter.temporary.TemporaryModel} with the resulting {@link uml.UmlPackage}
	 * 
	 * @param packagedElement the {@link mdxml.PackagedElement} to be converted
	 * @param tmpModel the {@link mdxmlconverter.temporary.TemporaryModel} where the id and package are added to
	 * @return the converted {@link uml.UmlPackage}
	 */
	 ...
	 * @param tmpModel the {@link mdxmlconverter.temporary.TemporaryModel} containing the references for all relevant elements
	 */
